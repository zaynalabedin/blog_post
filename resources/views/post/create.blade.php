                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('post-store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label> Name</label>
                            <input type="textarea" name="title" value="{{ old('title') }}" class="form-control" placeholder="Enter post Name">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" cols='30' rows='10' name="content" value="{{ old('content') }}" class="form-control" placeholder="Enter Your post Description"></textarea>
                            {{-- </textarea> --}}
