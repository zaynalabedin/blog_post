        ...
        <div class="col-sm-6 mt-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('superAdmin.update', $posts->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label> Name</label>
                            <input type="textarea" name="title" value="{{ $posts->title }}" class="form-control" placeholder="Enter post Name">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="content" class="form-control">{{ $posts->content }}</textarea>
                            {{-- </textarea> --}}
